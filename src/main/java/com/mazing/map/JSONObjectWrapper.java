...
public class JSONObjectWrapper {
  ...
  public JSONObjectWrapper getJsonObject(String key){
    try{
      return jsonObject.get(key)==null?new JSONObjectWrapper(new JSONObject()):new JSONObjectWrapper((JSONObject) jsonObject.get(key));
    }catch(ClassCastException e){
  ...
  public Boolean getBoolean(String key){
    try{
      return jsonObject.get(key)==null?false:(Boolean) jsonObject.get(key);
    }catch(ClassCastException e){
  ...
  public JSONArrayWrapper getJsonArray(String key){
    try{
      return jsonObject.get(key)==null?new JSONArrayWrapper(new JSONArray()):new JSONArrayWrapper((JSONArray) jsonObject.get(key));
    }catch(ClassCastException e){
